        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8">
            <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                <div className="space-y-4">
                    <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 px-8 py-10 space-y-4 hidden lg:block">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-4 py-5 sm:px-5">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-6 py-8 sm:px-8 w-full">
                    ...
                    {!loadingInvites && invites.length > 0 && (
                        <div className="mt-5 mb-4 rounded-lg border border-blue-100 bg-blue-50/60 px-3 py-3 text-xs text-slate-700">
                            ...
                            <p className="mt-1">
                                You can accept or decline them from your dashboard or from the pending invites section on this page.
                            </p>
                        </div>
                    )}
