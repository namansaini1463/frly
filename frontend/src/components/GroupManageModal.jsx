    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-2xl shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] flex flex-col">
        <div className="px-6 py-4 border-b flex items-center justify-between">
          <div>
            <h2 className="text-sm font-semibold text-gray-900">Manage Group</h2>
            <p className="text-xs text-gray-500 mt-0.5">View and manage group details, sections, and members.</p>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-6 text-sm">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <section>
              ...
              <div className="border rounded-lg max-h-52 overflow-y-auto divide-y divide-gray-100 bg-gray-50">
